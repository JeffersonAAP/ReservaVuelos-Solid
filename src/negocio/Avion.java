...
import negocio.Silla.Ubicacion;
...
public class Avion
{
    ...
    /**
     * Construye el avión.
     * Se inicializan las listas de sillas ejecutivas y económicas.
     */
    public Avion( )
    {
        Ubicacion ubicacion;
     ...
     * Si existe una silla con la clase y la ubicación dada, el pasajero queda asignado en la primera de ellas según el orden numérico.
     * @param pClase Clase elegida por el pasajero. Clase pertenece {Clase.EJECUTIVA, Clase.ECONOMICA}.
     * @param pUbicacion Ubicación elegida por el pasajero. Si clase = Clase.ECONOMICA entonces ubicación pertenece {VENTANA, CENTRAL, PASILLO}
     ...
     * La lista de sillas ejecutivas está inicializada.
     ...
     * La lista de sillas económicas está inicializada.
     ...
     * Si se encuentra una silla con el pasajero, la silla quedara con su pasajero igual a null.
